...
namespace Milhouzer.InventorySystem
{
    public class InventorySystemEditor : EditorWindow
    {
        ...
        [MenuItem("Milhouzer/InventorySystemEditor")]
        ...
        {
            ItemDatabase _itemDatabase = AssetDatabase.LoadAssetAtPath<ItemDatabase>("Assets/Milhouzer/InventorySystem/Databases/ItemDatabase.asset");
